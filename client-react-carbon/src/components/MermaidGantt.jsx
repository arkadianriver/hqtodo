...
import { makeMermaidText } from "/src/utils/makeMermaidText";
...
const MermaidGantt = (props) => {
  ...
  useLayoutEffect(() => {
    async function renderMermaid() {
      ...
      const mermaidText = await makeMermaidText(props.issues);
      const gantt = document.getElementById('ourgantt');
      const { svg, bindFunctions } = await mermaid.render("mermaid-svg", mermaidText);
      gantt.innerHTML = svg;
